...
\begin{itemize}
    ...
    \item \textbf{Transform (Target)} - Rate of participants recognizing the target identity of transformed samples (desensitized and stenography ones).
    \item \textbf{Transform (Phantom)} - Rate of recognizing the \textbf{original} identity of samples just mentioned.

...
\begin{itemize}
    \item \textbf{Intelligibility} - Rate of participants recognizing the original identity of the given sample.
    \item \textbf{Message Degradation} - Decrease of correct rate from original samples to extracted ones.
    \item \textbf{Transformation Performance} - Rate of participants recognizing the target identity of transformed samples (desensitized and stenography ones).
    \item \textbf{Gender Mixing} - Rate of participants mixing between speakers of the same gender.
\end{itemize}

...
\begin{figure}[htbp]
    \centerline{\includegraphics[width=8cm]{case1v2.png}}
    \caption{Case I - Idealized}
    \label{case1}
\end{figure}

\begin{figure}[htbp]
    \centerline{\includegraphics[width=8cm]{case2v2.png}}
...
\begin{figure}[htbp]
    \centerline{\includegraphics[width=8cm]{case3v2.png}}
...
\begin{figure}[htbp]
    \centerline{\includegraphics[width=8cm]{case4v2.png}}
...
\begin{figure}[htbp]
    \centerline{\includegraphics[width=8cm]{methodv2.png}}
...
\begin{figure}[htbp]
    ...
    \caption{Waveform of 4 Samples in Different Stages of Workflow}
    \label{samp1}
\end{figure}

...
\section{Problem statement, Ver. II}

\subsection{User}

User chooses to utilize attacker's voice-enabled service for its need. 

\subsection{Attacker}

Attacker's goal is to acquire the identities (i.e. voiceprints) of users by setting up a voice-enabled Internet service that acquires and processes user's voice sequences. The most straightforward

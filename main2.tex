...
It is straightforward to come up with a simple use case that an smartphone vendor provides its users with a desensitization service. But it secretly also want to identify its users after the users sending 

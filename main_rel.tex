...
\author{%%%% author names
    \IEEEauthorblockN{1\textsuperscript{st} Hai Huang}% first author
    , \IEEEauthorblockN{2\textsuperscript{nd} Jingzhi Zhang}% delete this line if not needed
    , \IEEEauthorblockN{3\textsuperscript{rd} Dixuan Chen}% delete this line if not needed
    , \IEEEauthorblockN{4\textsuperscript{th} Hongyang Yan}
    % duplicate the line above as many times as needed to list all authors
    \\%%%% author affiliations
    \IEEEauthorblockA{\textit{School of Computer Science and Cyber Engineering, Guangzhou University, Guangzhou, China}}\\% first affiliation
    \IEEEauthorblockA{\textit{Institute of Artificial Intelligence and Blockchain, Guangzhou University, Guanghzou, China}}\\% delete this line if not needed
    % duplicate the line above as many times as needed to list all affiliations
    %%%% corresponding author contact details
    % \IEEEauthorblockA{haihuang@e.gzhu.edu.cn, jzhi_zhang@e.gzhu.edu.cn, dickychen2000@gmail.com, hyang_yan@gzhu.edu.cn}
    \IEEEauthorblockA{\url{haihuang@e.gzhu.edu.cn}, \url{jzhi_zhang@e.gzhu.edu.cn}, \url{dickychen2000@gmail.com}, \url{hyang_yan@gzhu.edu.cn}}
}
